...
<td><a href="<?= $auto?>?orden=Modificar&codigo=<?=$peli->codigo_pelicula?>">no</a></td>
...
<input class="boton3dverpelis" type='submit' value='Nueva Película' >
</form>
<form name='f2' action='index.php'>
<input type='hidden' name='orden' value='Buscar'> 
<input class="boton3dverpelis2" type='submit' value='buscar Película' >
</form>
<?php
